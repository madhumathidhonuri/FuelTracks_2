...
const Users = () => {
  ...
  const handleToggleStatus = async (user) => {
    try {
      ...
      if (res.data.success) {
        alert(`User ${user.username} has been ${updatedStatus ? 'enabled' : 'disabled'}.`);
        fetchUsers();
      }
    } catch (err) {
      console.error(err);
    ...
    <div className="space-y-6 animate-fadeIn">
                    ...
                    <td className="py-4 px-4 text-center relative">
                      ...
                      {activeMenu === idx && (
                        ...
                        >
                          ...
                          <button
                            onClick={() => {
                              alert('Generating Audit Log Report...');
                              setActiveMenu(null);
                            }}
      ...
      {showEditModal && selectedUser && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[1000] p-4 backdrop-blur-sm animate-fadeIn">
          <div className="glass-card rounded-[24px] max-w-lg w-full overflow-hidden p-6 space-y-6">
            <div className="flex items-center justify-between border-b border-[rgba(61,122,138,0.15)] pb-4">
              <h3 className="text-lg font-bold font-display text-lb-800 dark:text-white">Edit User Settings</h3>
            ...
            <form onSubmit={handleEditSubmit} className="space-y-4 text-xs font-semibold">
              <div>
                <label className="block text-[10px] text-lb-400 uppercase tracking-wider mb-1.5">User Name</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-[10px] text-lb-400 uppercase tracking-wider mb-1.5">Email Address</label>
                <input
                  type="email"
              ...
              <div>
                <label className="block text-[10px] text-lb-400 uppercase tracking-wider mb-1.5">Mobile Number</label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-[10px] text-lb-400 uppercase tracking-wider mb-1.5">Role</label>
                  <select
                    value={editForm.role}
