  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/admin/audit/groups" element={<LayoutRoute element={AuditGroups} layout={AdminLayout} pageTitle="Group Audit" />} />
        <Route path="/admin/audit/organizations" element={<LayoutRoute element={AuditOrganizations} layout={AdminLayout} pageTitle="Organization Audit" />} />
